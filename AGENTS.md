...
- Before creating or changing a saveable editor or modal form, read [Stateful Forms](Docs/StatefulForms.md). Use `StatefulForm`, shared dirty-state parameters, guarded exits, and the completion checklist there instead of hand-rolling draft/save/cancel/dirty behavior.
